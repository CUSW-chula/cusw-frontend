...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      return (
        <div className={cn('font-semibold font-BaiJamjuree ', labelClassName)}>
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      ...
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="text-black font-BaiJamjuree font-medium  dark:text-neutral-400 w-[80px] text-start">
                              ...
                              {(() => {
                                ...
                                const dataKey =
                                  typeof item.dataKey === 'string'
                                    ...
                                    : '';
                                if (dataKey === 'assigned') return ` ${p.perAssigned}%`;
                                if (dataKey === 'inrecheck') return ` ${p.perInRecheck}%`;
                                if (dataKey === 'underreview') return ` ${p.perUnderReview}%`;
