...
export function WorkloadChart({ userWorkload }: UserWorkloadProps) {
  ...
  return (
    <>
      <CardContentCustom>
        <div className="w-full overflow-x-scroll bg-white py-[30px] px-[15px] rounded-md  outline outline-1 outline-stone-600 ">
        ...
        <TableBody className="block overflow-y-auto h-[500px] w-full">
          {userWorkload.map((user) => (
            <TableRow
              ...
              onClick={() => router.push(`/workload/${user.userId}`)}>
