...
function DatePickerWithRange({ dates }: dates) {
  ...
  React.useEffect(() => {
    ...
    const fetchDate = async () => {
      const from = dates.startDate ? dates.startDate : undefined;
      const to = dates.endDate ? dates.endDate : undefined;
      setDate({ from, to });
    };
